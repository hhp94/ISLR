...
Formatting and data processing ideas are heavily inspired by [Bisaria's post on Kaggle](https://www.kaggle.com/bisaria/titanic-lasso-ridge-implementation/code).    
...
to_split$ageclass = ifelse(to_split$age<=10,1,
                           ifelse(to_split$age>10 & to_split$age<=20,2,
                                  ifelse(to_split$age>20 & to_split$age<=35,3,4)))
to_split$ageclass = as.factor(to_split$ageclass)
...
write_csv(lasso, "./data/ridge.csv")
...
svm_2<-pred(svm_fit)
write_csv(svm_2,"./data/svm_2m_2.csv")
svm_1<-read_csv("./data/svm_1.csv")
